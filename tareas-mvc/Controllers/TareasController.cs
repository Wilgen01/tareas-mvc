...
namespace tareas_mvc.Controllers
{
    ...
    public class TareasController : ControllerBase
    {
        ...
        public async Task<ActionResult<Tarea>> Get(int id)
        {
            ...
            var tarea = await context.Tareas.Include(t => t.Pasos).FirstOrDefaultAsync(t => t.UsuarioCreacionId == usuarioId && t.Id == id);
        ...
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            var tareaEditar = await context.Tareas.FirstOrDefaultAsync(t => t.UsuarioCreacionId == usuarioId && t.Id == id);
